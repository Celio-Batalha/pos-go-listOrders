...
const file_internal_infra_grpc_proto_order_proto_rawDesc = "" +
	"\n" +
	"%internal/infra/grpc/proto/order.proto\x12\x02pb\"`\n" +
	"\x05Order\x12\x0e\n" +
	...
	"\x03tax\x18\x02 \x01(\x02R\x03tax\"n\n" +
	...
	"\tOrderList\x12!\n" +
	"\x06orders\x18\x01 \x03(\v2\t.pb.OrderR\x06orders\"h\n" +
	...
	"finalPrice2\x86\x01\n" +
	"\fOrderService\x12@\n" +
	"\vCreateOrder\x12\x16.pb.CreateOrderRequest\x1a\x17.pb.CreateOrderResponse\"\x00\x124\n" +
	"\n" +
	"ListOrders\x12\x15.pb.ListOrdersRequest\x1a\r.pb.OrderList\"\x00B\x18Z\x16internal/infra/grpc/pbb\x06proto3"
...
var file_internal_infra_grpc_proto_order_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
